...
import MAI.Core.Cluster.MPC_pb2 as MPC__pb2
...
class MPCServerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SetTensor = channel.unary_unary(
        '/MPCServer/SetTensor',
        request_serializer=MPC__pb2.Tensor.SerializeToString,
...
def add_MPCServerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SetTensor': grpc.unary_unary_rpc_method_handler(
          servicer.SetTensor,
          request_deserializer=MPC__pb2.Tensor.FromString,
